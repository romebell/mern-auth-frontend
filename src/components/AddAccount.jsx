...
const AddAccount = () => {
  const [institution_name, setInstitution_name] = useState(undefined);
  ...
  return (
    ...
    <div className="form-group">
      ...
      <input type="number" name="balance" value={balance} onChange={handleBalance} className="form-control"/>
    </div>
    <div className="form-group">
